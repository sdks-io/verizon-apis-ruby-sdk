...
module VerizonThingSpaceQualityOfServiceApiEndpoints
  ...
  class ThingspaceOauth < CoreLibrary::HeaderAuth
    ...
    def initialize(thingspace_oauth_credentials, config)
      @_o_auth_client_id = thingspace_oauth_credentials.o_auth_client_id unless
        thingspace_oauth_credentials.nil? || thingspace_oauth_credentials.o_auth_client_id.nil?
      @_o_auth_client_secret = thingspace_oauth_credentials.o_auth_client_secret unless
        thingspace_oauth_credentials.nil? || thingspace_oauth_credentials.o_auth_client_secret.nil?
      @_o_auth_token = thingspace_oauth_credentials.o_auth_token unless
        thingspace_oauth_credentials.nil? || thingspace_oauth_credentials.o_auth_token.nil?
      @_o_auth_clock_skew = thingspace_oauth_credentials.o_auth_clock_skew unless
        thingspace_oauth_credentials.nil? || thingspace_oauth_credentials.o_auth_clock_skew.nil?
      @_o_auth_token_provider = thingspace_oauth_credentials.o_auth_token_provider unless
        thingspace_oauth_credentials.nil? || thingspace_oauth_credentials.o_auth_token_provider.nil?
      @_o_auth_on_token_update = thingspace_oauth_credentials.o_auth_on_token_update unless
        thingspace_oauth_credentials.nil? || thingspace_oauth_credentials.o_auth_on_token_update.nil?
