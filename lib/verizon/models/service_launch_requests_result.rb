...
module Verizon
  # ServiceLaunchRequestsResult Model.
  class ServiceLaunchRequestsResult < BaseModel
    SKIP = Object.new
    ...
    # TODO: Write general description for this method
    # @return [Array[ServiceLaunchRequestResult]]
    ...
    def self.from_hash(hash)
      ...
      unless hash['resultSet'].nil?
        ...
        hash['resultSet'].each do |structure|
          result_set << (ServiceLaunchRequestResult.from_hash(structure) if structure)
        end
      end
      ...
      ServiceLaunchRequestsResult.new(count,
                                      mnext,
                                      previous,
                                      result_set)
    end
