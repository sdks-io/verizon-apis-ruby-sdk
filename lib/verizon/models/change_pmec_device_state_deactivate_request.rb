...
module Verizon
  # ChangePmecDeviceStateDeactivateRequest Model.
  class ChangePmecDeviceStateDeactivateRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      ChangePmecDeviceStateDeactivateRequest.new(account_name,
                                                 device_list)
    end
  end
end
